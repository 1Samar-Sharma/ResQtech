...
export const CommunityFeed: React.FC<CommunityFeedProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSubmitReport({
      ...
      coordinates: {
        lat: (userLocation && Number.isFinite(userLocation.lat) ? userLocation.lat : 28.6139) + (Math.random() * 0.008 - 0.004),
        lng: (userLocation && Number.isFinite(userLocation.lng) ? userLocation.lng : 77.2090) + (Math.random() * 0.008 - 0.004),
      },
      severity,
