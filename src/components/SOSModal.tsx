        ...
        <div className="p-3.5 rounded-2xl bg-white/[0.04] backdrop-blur-md border border-rose-500/30 space-y-2">
          <div className="flex items-center justify-between text-[11px]">
            ...
            <span className="font-mono text-emerald-400 font-bold">
              {(userLocation && Number.isFinite(userLocation.lat) ? userLocation.lat : 28.6139).toFixed(5)}, {(userLocation && Number.isFinite(userLocation.lng) ? userLocation.lng : 77.2090).toFixed(5)} (Accurate to 3m)
            </span>
          </div>
