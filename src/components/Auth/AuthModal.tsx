      ...
      <div className="w-full max-w-lg bg-[#080d1a] border border-white/15 rounded-3xl p-5 sm:p-8 shadow-2xl shadow-black/80 space-y-4 relative overflow-hidden animate-fadeIn text-slate-100 my-auto">
        ...
        <div className="relative flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-sky-500 to-blue-600 flex items-center justify-center shadow-lg shadow-sky-500/30 border border-white/20 flex-shrink-0">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full bg-sky-500/20 text-sky-300 border border-sky-500/40 text-[9px] font-bold uppercase tracking-wider">
                  Firebase Auth
                </span>
              </div>
              <p className="text-xs text-slate-400 mt-0.5">
                Conversational Weather Forecasting & Climate Intelligence
              </p>
            </div>
          </div>
          ...
          {canDismiss && currentUser ? (
            ...
            <div className="flex items-center gap-1 px-2.5 py-1 rounded-xl bg-sky-500/20 border border-sky-500/40 text-sky-300 text-[10px] font-bold uppercase tracking-wider">
        ...
        {!currentUser && (
          <div className="p-3 rounded-2xl bg-gradient-to-r from-sky-600/15 via-blue-600/10 to-cyan-600/10 border border-sky-500/30 flex items-start gap-2.5">
            <ShieldCheck className="w-4 h-4 text-sky-400 flex-shrink-0 mt-0.5" />
            <div className="text-xs">
              <span className="font-bold text-sky-200">Firebase Authentication: </span>
              <span className="text-slate-300">
                Sign in with your Google account to sync your personalized WeatherGPT chats, agro advisories, and weather alert notifications.
              </span>
            </div>
          </div>
        )}
        ...
        <div className="space-y-2">
          <button
            ...
            className="w-full py-3 px-4 rounded-2xl bg-white hover:bg-slate-100 text-slate-900 font-bold text-xs sm:text-sm flex items-center justify-center gap-3 shadow-lg shadow-white/10 transition-all active:scale-[0.98] disabled:opacity-60 cursor-pointer"
          >
