          ...
          <div className="py-8 space-y-6 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-400 text-xs max-w-md mx-auto">
                Transmitting real-time GPS coordinates ({userLocation && Number.isFinite(userLocation.lat) ? userLocation.lat.toFixed(4) : '28.6139'}, {userLocation && Number.isFinite(userLocation.lng) ? userLocation.lng.toFixed(4) : '77.2090'}) to nearby citizens and emergency response teams...
              </p>
            </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-300 truncate max-w-sm">
                    {userAddress} ({userLocation && Number.isFinite(userLocation.lat) ? userLocation.lat.toFixed(4) : '28.6139'}°, {userLocation && Number.isFinite(userLocation.lng) ? userLocation.lng.toFixed(4) : '77.2090'}°)
                  </p>
                </div>
              </div>
